...
public class MainActivity extends AppCompatActivity {
    ...
    static final String modeFile = "Mode";
    static SoundPool keySoundPool;
    static HashMap<String, Integer> keySoundPoolMap;
    static HashMap<String, Integer> keyStreamMap;
    static SoundPool sampleSoundPool;
    static HashMap<String, Integer> sampleSoundPoolMap;
    static MediaRecorder recorder = null;
    static String mFileName = null;
    static String mFileNameBase = null;
    static String[] currSampleArray;
    static List<String> sampleList;
    static Map<String, String[]> presetMap;
    ...
    class SwapKeys extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            KeySetup keySetup = new KeySetup();
            if (result == 0) {
                keySetup.keyPressSetupSynth();
            } else {
                keySetup.keyPressSetupPiano();
            }
    ...
    class KeySetup {
        ...
        private void synthLoad() {
            keyStreamMap = new HashMap<>();
            keySoundPoolMap = new HashMap<>();
            keySoundPoolMap.put("C4", keySoundPool.load(MainActivity.this, R.raw.c4synth, 1));
            keySoundPoolMap.put("C4sharp", keySoundPool.load(MainActivity.this, R.raw.c4sharpsynth, 1));
            keySoundPoolMap.put("D4", keySoundPool.load(MainActivity.this, R.raw.d4synth, 1));
            keySoundPoolMap.put("D4sharp", keySoundPool.load(MainActivity.this, R.raw.d4sharpsynth, 1));
            keySoundPoolMap.put("E4", keySoundPool.load(MainActivity.this, R.raw.e4synth, 1));

            keySoundPoolMap.put("F4", keySoundPool.load(MainActivity.this, R.raw.f4synth, 1));
            keySoundPoolMap.put("F4sharp", keySoundPool.load(MainActivity.this, R.raw.f4sharpsynth, 1));
            keySoundPoolMap.put("G4", keySoundPool.load(MainActivity.this, R.raw.g4synth, 1));
            keySoundPoolMap.put("G4sharp", keySoundPool.load(MainActivity.this, R.raw.g4sharpsynth, 1));
            keySoundPoolMap.put("A4", keySoundPool.load(MainActivity.this, R.raw.a4synth, 1));
            keySoundPoolMap.put("A4sharp", keySoundPool.load(MainActivity.this, R.raw.a4sharpsynth, 1));
            keySoundPoolMap.put("B4", keySoundPool.load(MainActivity.this, R.raw.b4synth, 1));

            keySoundPoolMap.put("C5", keySoundPool.load(MainActivity.this, R.raw.c5synth, 1));
            keySoundPoolMap.put("C5sharp", keySoundPool.load(MainActivity.this, R.raw.c5sharpsynth, 1));
            keySoundPoolMap.put("D5", keySoundPool.load(MainActivity.this, R.raw.d5synth, 1));
            keySoundPoolMap.put("D5sharp", keySoundPool.load(MainActivity.this, R.raw.d5sharpsynth, 1));
            keySoundPoolMap.put("E5", keySoundPool.load(MainActivity.this, R.raw.e5synth, 1));
        }


        private void keyPressSetupSynth() {

            final Button keyC4 = (Button) MainActivity.this.findViewById(R.id.key1);
            final Button keyC4sharp = (Button) MainActivity.this.findViewById(R.id.blackkey1);
            final Button keyD4 = (Button) MainActivity.this.findViewById(R.id.key2);
            final Button keyD4sharp = (Button) MainActivity.this.findViewById(R.id.blackkey2);
            final Button keyE4 = (Button) MainActivity.this.findViewById(R.id.key3);

            final Button keyF4 = (Button) MainActivity.this.findViewById(R.id.key4);
            final Button keyF4sharp = (Button) MainActivity.this.findViewById(R.id.blackkey3);
            final Button keyG4 = (Button) MainActivity.this.findViewById(R.id.key5);
            final Button keyG4sharp = (Button) MainActivity.this.findViewById(R.id.blackkey4);
            final Button keyA4 = (Button) MainActivity.this.findViewById(R.id.key6);
            final Button keyA4sharp = (Button) MainActivity.this.findViewById(R.id.blackkey5);

            final Button keyB4 = (Button) MainActivity.this.findViewById(R.id.key7);
            final Button keyC5 = (Button) MainActivity.this.findViewById(R.id.key8);
            final Button keyC5sharp = (Button) MainActivity.this.findViewById(R.id.blackkey6);
            final Button keyD5 = (Button) MainActivity.this.findViewById(R.id.key9);
            final Button keyD5sharp = (Button) MainActivity.this.findViewById(R.id.blackkey7);
            final Button keyE5 = (Button) MainActivity.this.findViewById(R.id.key10);
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            ...
                            keyStreamMap.put("C4", new PlayKeys().playSynthSound("C4"));
            ...
            keyC4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("C4sharp", new PlayKeys().playSynthSound("C4sharp"));
            ...
            keyD4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("D4", new PlayKeys().playSynthSound("D4"));
            ...
            keyD4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("D4sharp", new PlayKeys().playSynthSound("D4sharp"));
            ...
            keyE4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("E4", new PlayKeys().playSynthSound("E4"));
            ...
            keyF4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("F4", new PlayKeys().playSynthSound("F4"));
            ...
            keyF4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("F4sharp", new PlayKeys().playSynthSound("F4sharp"));
            ...
            keyG4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("G4", new PlayKeys().playSynthSound("G4"));
            ...
            keyG4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("G4sharp", new PlayKeys().playSynthSound("G4sharp"));
            ...
            keyA4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("A4", new PlayKeys().playSynthSound("A4"));
            ...
            keyA4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("A4sharp", new PlayKeys().playSynthSound("A4sharp"));
            ...
            keyB4.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("B4", new PlayKeys().playSynthSound("B4"));
            ...
            keyC5.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("C5", new PlayKeys().playSynthSound("C5"));
            ...
            keyC5sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("C5sharp", new PlayKeys().playSynthSound("C5sharp"));
            ...
            keyD5.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("D5", new PlayKeys().playSynthSound("D5"));
            ...
            keyD5sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("D5sharp", new PlayKeys().playSynthSound("D5sharp"));
            ...
            keyE5.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            keyStreamMap.put("E5", new PlayKeys().playSynthSound("E5"));
        ...
        private void pianoLoad() {
            keySoundPoolMap = new HashMap<>();
            keyStreamMap = new HashMap<>();
            keySoundPoolMap.put("C4", keySoundPool.load(MainActivity.this, R.raw.c4, 1));
            keySoundPoolMap.put("C4sharp", keySoundPool.load(MainActivity.this, R.raw.c4sharp, 1));
            keySoundPoolMap.put("D4", keySoundPool.load(MainActivity.this, R.raw.d4, 1));
            keySoundPoolMap.put("D4sharp", keySoundPool.load(MainActivity.this, R.raw.d4sharp, 1));
            keySoundPoolMap.put("E4", keySoundPool.load(MainActivity.this, R.raw.e4, 1));

            keySoundPoolMap.put("F4", keySoundPool.load(MainActivity.this, R.raw.f4, 1));
            keySoundPoolMap.put("F4sharp", keySoundPool.load(MainActivity.this, R.raw.f4sharp, 1));
            keySoundPoolMap.put("G4", keySoundPool.load(MainActivity.this, R.raw.g4, 1));
            keySoundPoolMap.put("G4sharp", keySoundPool.load(MainActivity.this, R.raw.g4sharp, 1));
            keySoundPoolMap.put("A4", keySoundPool.load(MainActivity.this, R.raw.a4, 1));
            keySoundPoolMap.put("A4sharp", keySoundPool.load(MainActivity.this, R.raw.a4sharp, 1));
            keySoundPoolMap.put("B4", keySoundPool.load(MainActivity.this, R.raw.b4, 1));

            keySoundPoolMap.put("C5", keySoundPool.load(MainActivity.this, R.raw.c5, 1));
            keySoundPoolMap.put("C5sharp", keySoundPool.load(MainActivity.this, R.raw.c5sharp, 1));
            keySoundPoolMap.put("D5", keySoundPool.load(MainActivity.this, R.raw.d5, 1));
            keySoundPoolMap.put("D5sharp", keySoundPool.load(MainActivity.this, R.raw.d5sharp, 1));
            keySoundPoolMap.put("E5", keySoundPool.load(MainActivity.this, R.raw.e5, 1));
        }
            ...
            keyC4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("C4sharp");
                            keyC4sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyD4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("D4sharp");
                            keyD4sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyF4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("F4sharp");
                            keyF4sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyG4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("G4sharp");
                            keyG4sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyA4sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("A4sharp");
                            keyA4sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyC5sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("C5sharp");
                            keyC5sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
            ...
            keyD5sharp.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // PRESSED
                            new PlayKeys().playKeySound("D5sharp");
                            keyD5sharp.setBackgroundResource(R.drawable.key_pressed);
                            return true;
                        case MotionEvent.ACTION_UP:
                            // RELEASED
    ...
    class Preset {
        ...
        Map<String, String[]> getPresetMap() {
        ...
        void presetOverwrite(final String presetToAdd) {
            ...
            acceptButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    presetMap.put(presetToAdd, new Samples().getSampleArray());
                    dialog.dismiss();
                }
            });
            ...
            if (presetList != null) {
                ...
                presetListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        samples.putSampleArray(buttonArray);

                        dialog.dismiss();
                        samples.samplePlayMode();
                ...
                public void onClick(View v) {
                    ...
                    if (presetMap != null) {
                        if (presetMap.get(presetName.getText().toString()) != null) {
                            ...
                            presetMap.put(presetName.getText().toString(), new Samples().getSampleArray());
                            presetList.add(presetName.getText().toString());
                        }
                    } else {
                        Log.d("D", "No Preset Map");
                    }
    ...
    class Samples {
        ...
        private void playSampleSound(String sound) {
            AudioManager mgr = (AudioManager) MainActivity.this.getBaseContext().getSystemService(Context.AUDIO_SERVICE);
    ...
    void init() {
        ...
        samples.getCurrSampleArray();
        samples.putSampleArray(currSampleArray);
    }
    ...
    protected void onStop() {
        ...
        Preset preset = new Preset();
        Samples samples = new Samples();
        samples.saveCurrSampleArray();
        preset.presetCleanup();
        preset.savePresetList();
        preset.savePresetMap();
        samples.saveSampleList();
